...
* библиотека bootstrap подключена через npm
...
* обновлена библиотека accept-cookie-popup
* обновлено макет, подключение и вызов модальных окон Hystmodal
* добавлен функционал отправки форм в формате JSON
