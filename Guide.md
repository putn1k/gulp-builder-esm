...
`npm run minify` - команда, аналогичная команде `npm run prod` + сборка js и webpak'ом.

`npm run prebuild` - команда, аналогичная команде `npm run prod` + проверка линтерами js и scss кода перед сборкой.

`npm run build` - команда, аналогичная команде `npm run minify` + проверка линтерами js и scss кода перед сборкой.
